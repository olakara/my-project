        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedTimestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectInvitations_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                    Role = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    JoinedTimestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedTimestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    EditedTimestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangedTimestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskHistory_AspNetUsers_ChangedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_CreatedTimestamp",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_CreatedTimestamp",
                table: "Notifications",
                column: "CreatedTimestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectInvitations_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_CreatedTimestamp",
                table: "Projects",
                column: "CreatedTimestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskHistory_ChangedTimestamp",
                table: "TaskHistory",
                column: "ChangedTimestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_CreatedTimestamp",
                table: "Tasks",
                column: "CreatedTimestamp");
